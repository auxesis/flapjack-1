$(document).ready(function() {
  ...
  app.MediaCollection = Backbone.Collection.extend({
    model:      app.Media,
    comparator: 'id',
    urlType: 'media',
    url: function() { return app.api_url + "/" + this.urlType; }
  ...
  app.Contact = Backbone.Model.extend({
    ...
    linkages: {
      ...
      // Please forgive me. Plurals in greek don't work when programming. - @auxesis
      media: app.Media,
      medias: app.MediaCollection,
    },
    urlType: 'contacts',
    urlRoot: function() { return app.api_url + "/" + this.urlType; }
  });
